...
class signalProcessing:
    ...
    def extractPulsePeaks(self, pulseTime, normalizedPulse, pulseVelocity, pulseAcceleration):
        ...
        dicroticNotchInd = self.findNearbyMinimum(normalizedPulse, tidalEndInd, binarySearchWindow = 2, maxPointsSearch = int(len(pulseTime)/2))
    ...
    def extractFeatures(self, normalizedPulse, pulseTime, pulseVelocity, pulseAcceleration, allSystolicPeaks, allTidalPeaks, allDicroticPeaks):
        ...
        beforeTidalVelMinTime, tidalStartTime, tidalPeakTime, tidalEndTime, afterTidalVelMinTime = pulseTime[allTidalPeaks]
        ...
        beforeTidalVelMinAmp, tidalStartAmp, tidalPeakAmp, tidalEndAmp, afterTidalVelMinAmp = normalizedPulse[allTidalPeaks]
        ...
        beforeTidalVelMinVel, tidalStartVel, tidalPeakVel, tidalEndVel, afterTidalVelMinVel = pulseVelocity[allTidalPeaks]
        ...
        beforeTidalVelMinAccel, tidalStartAccel, tidalPeakAccel, tidalEndAccel, afterTidalVelMinAccel = pulseAcceleration[allTidalPeaks]
        ...
        outerTidalInterval = afterTidalVelMinTime - beforeTidalVelMinTime
        midToEndTidal = afterTidalVelMinTime - tidalPeakTime
        ...
        # General Areas
        systolicUpSlopeArea = scipy.integrate.simpson(normalizedPulse[systolicUpstrokeAccelMaxInd:systolicUpstrokeAccelMinInd], pulseTime[systolicUpstrokeAccelMaxInd:systolicUpstrokeAccelMinInd])
        velToTidalArea = scipy.integrate.simpson(normalizedPulse[systolicUpstrokeVelInd:tidalPeakInd], pulseTime[systolicUpstrokeVelInd:tidalPeakInd])
        ...
        SystolicSlopeDown = np.polyfit(pulseTime[beforeTidalVelMinInd:tidalStartInd], normalizedPulse[beforeTidalVelMinInd:tidalStartInd], 1)[0]
        SystolicSlopeDown2 = np.polyfit(pulseTime[tidalEndInd:afterTidalVelMinInd], normalizedPulse[tidalEndInd:afterTidalVelMinInd], 1)[0]

...
class signalProcessing:
    ...
    def extractFeatures(self, xData, baselineData, peakInd, chemicalName):
        ...
        plt.plot(xData, peakHeight*thirdDeriv/max(abs(thirdDeriv)), 'tab:brown')
        plt.plot(xData, peakHeight*forthDeriv/max(abs(forthDeriv)), 'tab:purple')
        ...
        maxAccelRightInd = self.findNearbyMaximum(acceleration, rightVelPeakInd, binarySearchWindow = -2)
